...
export function Habilidades() {
  ...
  return (
    <Paralax>
      <Grid templateColumns='repeat(3, 1fr)' gap={6} height="100vh" alignContent='center'>
          <Text fontFamily='Roboto' mb='20px' fontSize='20px' fontWeight='700'>Conhecimentos/Habilidades</Text>
          {habili.map((item: any, index) => (
            <Box
              ...
              fontSize="20px"
            >
              <Flex flexDirection='column' w='20vw'h='20vh' align='center'justify={'center'} bg='gray.600' borderRadius='0.25rem'>
